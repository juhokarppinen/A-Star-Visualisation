...
/// <summary>
/// The namespace for pathfinding algorithms.
/// </summary>
namespace PathFinding
{
	/// <summary>
	/// A static class containing an implementation of the A* algorithm
	/// </summary>
	public static class AStar
	{
		/// <summary>
		/// A simple default value wrapper for a dictionary. The default value is float.MaxValue.
		/// </summary>
